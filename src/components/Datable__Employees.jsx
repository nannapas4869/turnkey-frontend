...
const DataTable_Employee = () => {
  ...
  const data = [
    [
      ...
      <Link to="/AssignEmployee"><button className="bg-[#FEB135] text-white py-4 px-9 rounded-full">Edit</button></Link>,
    ],
    [
      2,
      "Lynn Brown",
...
const TableWithSubmitButton = ({ data }) => {
  ...
  return (
    <div className="overflow-x-auto mb-5">
      ...
      className={`${
        rowIndex === 0
          ? "bg-green-300" // Apply green background for row 0
          : rowIndex % 2 === 0
          ? "bg-white"
          : "bg-gray-50"
      }`}
      ...
      <div className="container mx-auto px-4 pb-10">
        <div className="flex justify-end mt-10 ">
          <Link to="/Deadline">
          <button
            className="background_blue button__style cursor-pointer"
